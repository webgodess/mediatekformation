 ...
 */
final class Version20260609124503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, formation_id INT NOT NULL, contenu LONGTEXT NOT NULL, date_publication DATETIME DEFAULT NULL, est_valide TINYINT(1) NOT NULL, INDEX IDX_67F068BC5200282E (formation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
